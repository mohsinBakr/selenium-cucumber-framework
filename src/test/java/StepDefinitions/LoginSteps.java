...
public class LoginSteps {
    ...
    public void loginPageIsDisplayed() {
        ...
        Assert.assertEquals(actualLoginHeaderTitle, "Silakan masuk ke akun Anda");

        String actualRegisterQuestionText = loginPage.getQuestionRegisterText();
        Assert.assertEquals(actualRegisterQuestionText, "Belum punya akun Bhinneka? Register");
    }
